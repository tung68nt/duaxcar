                ...
                {activeTab === "general" && (
                    <div className="space-y-4 animate-fadeIn">
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            <h3 className="font-heading font-bold text-[var(--color-text)] text-sm flex items-center gap-2 border-b border-[var(--color-border)] pb-2">
                                <Globe className="w-4 h-4 text-[var(--color-primary)]" />
                                <span>Cấu hình thương hiệu</span>
                            </h3>
                            <div className="grid sm:grid-cols-2 gap-3">
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Tên thương hiệu</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Khẩu hiệu / Slogan</label>
                                    <input
                                        type="text"
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <MediaSelectorInput
                                    ...
                                    description="Logo hiển thị chính thức (khuyên dùng PNG trong suốt)"
                                ...
                                <MediaSelectorInput
                                    ...
                                    description="Icon tab & bookmark trình duyệt (khuyên dùng tỉ lệ vuông)"
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            ...
                            <div className="grid sm:grid-cols-2 gap-3">
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Số điện thoại liên hệ</label>
                                    <input
                                        type="text"
                                        value={config.phone}
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Hotline tuyển sinh</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Email liên hệ</label>
                                    <input
                                        type="email"
                                        value={config.email}
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Địa chỉ trụ sở chính</label>
                                    <input
                                        type="text"
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            ...
                            <div className="grid sm:grid-cols-2 gap-3">
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1 flex items-center gap-1">
                    ...
                    <div className="space-y-4 animate-fadeIn">
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            ...
                            <div className="space-y-3">
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Tiêu đề chính (Hero Title)</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Mô tả phụ (Hero Subtitle)</label>
                                    <textarea
                                        value={config.heroSubtitle}
                                        onChange={(e) => setConfig({ ...config, heroSubtitle: e.target.value })}
                                        rows={2}
                                        className="w-full bg-[var(--color-background)] border border-[var(--color-border)] rounded-lg px-3 py-2 text-xs text-[var(--color-text)] focus:border-[var(--color-primary)] focus:outline-none resize-none"
                                        required
                                    />
                                </div>
                            </div>
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            <div className="flex items-center justify-between border-b border-[var(--color-border)] pb-2">
                                <h3 className="font-heading font-bold text-[var(--color-text)] text-sm flex items-center gap-2">
                            ...
                            <div className="grid sm:grid-cols-2 gap-3">
                                {config.heroBanners.map((banner, index) => (
                                    <div key={banner.id} className="p-3 bg-[var(--color-surface-light)]/40 border border-[var(--color-border)] rounded-xl space-y-2 relative group">
                                        <button
                                            type="button"
                                            onClick={() => handleRemoveBanner(index)}
                                            className="absolute top-2 right-2 p-1 bg-red-500/10 text-red-500 rounded-lg hover:bg-red-500 hover:text-white transition-all z-10"
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-[var(--color-background)] border border-[var(--color-border)] rounded-lg px-2.5 py-1.5 text-xs text-[var(--color-text)] focus:border-[var(--color-primary)] focus:outline-none"
                    ...
                    <div className="space-y-4 animate-fadeIn">
                        ...
                        <div className="p-4 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl space-y-3">
                            ...
                            <div className="space-y-3">
                                <div className="grid sm:grid-cols-2 gap-3">
                                    <div>
                                        <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Tiêu đề Hero chính</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Mô tả phụ Hero</label>
                                        <input
                                            type="text"
                                ...
                                <div className="grid sm:grid-cols-2 gap-3">
                                    <div className="space-y-3">
                                        <div>
                                            <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Tiêu đề sứ mệnh (Story Title)</label>
                                            <input
                                                type="text"
                                ...
                                <div>
                                    <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Nội dung câu chuyện (Story Content)</label>
                                    <textarea
                                ...
                                <div className="grid sm:grid-cols-2 gap-3">
                                    <div>
                                        <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Tầm nhìn (Vision)</label>
                                        <textarea
                                    ...
                                    <div>
                                        <label className="text-xs font-semibold text-[var(--color-text-secondary)] block mb-1">Sứ mệnh (Mission)</label>
                                        <textarea
