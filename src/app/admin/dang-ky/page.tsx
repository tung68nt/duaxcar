...
export default function AdminRegistrations() {
    ...
    const getStatusBadge = (status: string) => {
        switch(status) {
            ...
            case "contacted":
                return <span className="px-2.5 py-0.5 bg-blue-500/10 text-blue-500 rounded-md font-medium text-xs flex items-center gap-1.5 w-fit"><PhoneCall className="w-3.5 h-3.5" /> Đã liên hệ</span>;
            case "enrolled":
