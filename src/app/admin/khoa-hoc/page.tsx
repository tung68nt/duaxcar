        ...
        <div className="space-y-4">
            ...
            <div className="p-3.5 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl flex flex-col md:flex-row gap-3 items-center justify-between">
                ...
                <div className="flex gap-1.5 w-full md:w-auto">
                    ...
                    >
                        Trực tiếp ({courses.filter(c => c.courseType === "onsite").length})
                    </button>
                    <button
                    ...
                    >
                        E-learning ({courses.filter(c => c.courseType === "elearning").length})
                    </button>
                </div>
            </div>
                                ...
                                filteredCourses.map((course) => (
                                    <tr key={course.id} className="hover:bg-[var(--color-surface-light)]/40 transition-colors">
                                        <td className="px-4 py-2.5">
                                            ...
                                            <div className="text-[10px] text-[var(--color-text-muted)] mt-0.5">Giảng viên: {course.instructor}</div>
                                        </td>
                                        <td className="px-4 py-2.5">
                                            {course.courseType === "onsite" ? (
                                                <span className="px-2 py-0.5 bg-green-500/10 text-green-500 border border-green-500/20 rounded-md text-[10px] font-semibold">Trực tiếp</span>
                                            ) : (
                                                <span className="px-2 py-0.5 bg-purple-500/10 text-purple-500 border border-purple-500/20 rounded-md text-[10px] font-semibold">Online (E-learning)</span>
                                            )}
                                        </td>
                                        <td className="px-4 py-2.5 text-[var(--color-primary)] font-bold">
